...
import { GaxiosOptions, GaxiosResponse } from '@google-cloud/common/node_modules/google-auth-library/build/src/auth/node_modules/gaxios';
import * as stream from 'stream';
import { DefaultTransporter, Transporter } from '@google-cloud/common/node_modules/google-auth-library/build/src/transporters';
import { Compute } from '@google-cloud/common/node_modules/google-auth-library/build/src/auth/computeclient';
import { CredentialBody, JWTInput } from '@google-cloud/common/node_modules/google-auth-library/build/src/auth/credentials';
import { GCPEnv } from '@google-cloud/common/node_modules/google-auth-library/build/src/auth/envDetect';
import { JWT, JWTOptions } from '@google-cloud/common/node_modules/google-auth-library/build/src/auth/jwtclient';
import { Headers, OAuth2Client, OAuth2ClientOptions, RefreshOptions } from '@google-cloud/common/node_modules/google-auth-library/build/src/auth/oauth2client';
import { UserRefreshClient, UserRefreshClientOptions } from '@google-cloud/common/node_modules/google-auth-library/build/src/auth/refreshclient';
