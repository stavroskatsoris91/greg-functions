import * as express from 'firebase-functions/lib/node_modules/express';
import * as analytics from 'firebase-functions/lib/providers/analytics';
import * as auth from 'firebase-functions/lib/providers/auth';
import * as crashlytics from 'firebase-functions/lib/providers/crashlytics';
import * as database from 'firebase-functions/lib/providers/database';
import * as firestore from 'firebase-functions/lib/providers/firestore';
import * as https from 'firebase-functions/lib/providers/https';
import * as pubsub from 'firebase-functions/lib/providers/pubsub';
import * as remoteConfig from 'firebase-functions/lib/providers/remoteConfig';
import * as storage from 'firebase-functions/lib/providers/storage';
import { CloudFunction, EventContext, Schedule } from 'firebase-functions/lib/cloud-functions';
...
export declare class FunctionBuilder {
    ...
    readonly https: {
         ...
         */
        onRequest: (handler: (req: https.Request, resp: express.Response) => void) => import("firebase-functions/lib/cloud-functions").HttpsFunction;
        /**
         * Declares a callable method for clients to call using a Firebase SDK.
         * @param handler A method that takes a data and context and returns a value.
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any) => import("firebase-functions/lib/cloud-functions").TriggerAnnotated & ((req: express.Request, resp: express.Response) => void) & import("firebase-functions/lib/cloud-functions").Runnable<any>;
    };
    readonly database: {
        /**
